...
def def_ont_agrif_rdf_1():
    ...
    r = requests.get('http://reference.data.gov.au/def/ont/agrif', headers={'Accept': 'text/turtle'})
    ...
    assert title == 'The Australian Government Records Interoperability Framework (AGRIF) ontology', \
